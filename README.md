...
BOM (links to Distributors are only examples):
-----------------------------------------------------------------------------------------------------
1x PCB: custom order with gerber files e.g. from https://www.jlcpcb.com

1x Torroid	Fair-Rite	5943001001 (alt. Amidon FT114-43)	
...
1x BNC Socket - Molex	731385033	(Hint: Using alternative Parts might be possible, take care about clearence between PCB and BNC-Plug (most BNC-Sockets are lower, so you cant connect a socket when soldert on PCB)
...
80mm	Shrink tube 40mm - ISOLATECH	Shrink Tube 40mm  3:1 with glue	
